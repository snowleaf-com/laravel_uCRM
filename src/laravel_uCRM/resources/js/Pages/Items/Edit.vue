                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                          <div class="flex flex-wrap -m-2">
                            <div class="p-2 w-full">
                              <div class="relative">
                                <label for="name" class="leading-7 text-sm text-gray-600">商品名</label><InputError :message="errors.name" />
                            ...
                            <div class="p-2 w-full">
                              <div class="relative">
                                <label for="price" class="leading-7 text-sm text-gray-600">値段</label><InputError :message="errors.price" />
                            ...
                            <div class="p-2 w-full">
                              <div class="relative">
                                <label class="leading-7 text-sm text-gray-600">ステータス</label><InputError :message="errors.is_selling" />
                                <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1" class="ml-8">
                                <label for="is_selling" class="ml-2 mr-4">販売中</label>
                                <input type="radio" id="is_stopping" name="is_stopping" v-model="form.is_selling" value="0">
                                <label for="is_stopping" class="ml-2 mr-4">停止中</label>
                              </div>
                            </div>
                            <div class="p-2 w-full">
